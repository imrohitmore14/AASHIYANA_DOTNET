...
namespace RolesAuth.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,Email,Password,Dob,Address,Phone")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,Email,Password,Dob,Address,Phone")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
