    ...
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Hotels != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Hotels'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("HotelId,Name,Address,City,Country")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HotelId,Name,Address,City,Country")] Hotel hotel)
        {
            if (id != hotel.HotelId)
            {
                return NotFound();
